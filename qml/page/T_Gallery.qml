    ...
    */
    ...
    FluFrame {
        ...
        FluIconButton {
            ...
            pressedColor: deleteMode ? (FluTheme.dark ? Qt.rgba(175 / 255, 0, 0, 0.6) : Qt.rgba(255 / 255, 73 / 255, 73 / 255, 0.9)) : (FluTheme.dark ? Qt.rgba(1, 1, 1, 0.06) : Qt.rgba(0, 0, 0, 0.06))
            normalColor: deleteMode ? (FluTheme.dark ? Qt.rgba(175 / 255, 0, 0, 0.9) : Qt.rgba(255 / 255, 73 / 255, 73 / 255, 0.6)) : (FluTheme.dark ? Qt.rgba(0, 0, 0, 0) : Qt.rgba(0, 0, 0, 0))
            hoverColor: deleteMode ? (FluTheme.dark ? Qt.rgba(175 / 255, 0, 0, 0.75) : Qt.rgba(255 / 255, 73 / 255, 73 / 255, 0.75)) : (FluTheme.dark ? Qt.rgba(1, 1, 1, 0.03) : Qt.rgba(0, 0, 0, 0.03))
