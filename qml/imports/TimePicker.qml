...
Rectangle {
    property color dividerColor: FluTheme.dark ? Qt.rgba(
                                                     77 / 255, 77 / 255,
                                                     77 / 255,
                                                     1) : Qt.rgba(239 / 255, 239
                                                                  / 255, 239 / 255, 1)
    property color hoverColor: FluTheme.dark ? Qt.rgba(
                                                   68 / 255, 68 / 255,
                                                   68 / 255,
                                                   1) : Qt.rgba(251 / 255, 251 / 255, 251 / 255, 1)
    property color normalColor: FluTheme.dark ? Qt.rgba(
                                                    61 / 255, 61 / 255,
                                                    61 / 255,
    ...
    property alias hour_value: text_hour.text
    property alias minite_value: text_minute.text
    id: control
    color: {
    ...
    Menu {
                                ...
                                color: {
                                    ...
                                    if (item_mouse.containsMouse) {
                                        return FluTheme.dark ? Qt.rgba(
                                                                   ...
                                                                   60 / 255,
                                                                   61 / 255,
                                                                   1) : Qt.rgba(237 / 255, 237 / 255, 242 / 255, 1)
                                    }
        ...
        function showPopup() {
            ...
            hour = text_hour.text === "时" ? hour.toString().padStart(
                                                2, '0') : text_hour.text
            var minute = text_minute.text === "分" ? now.getMinutes().toString(
                                                        ).padStart(
                                                        2,
                                                        '0') : text_minute.text
