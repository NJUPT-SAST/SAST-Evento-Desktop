...
void SlideManagementEditController::createSlide(const QString& title, const QString& link,
                                                const QString& url) {
    // TODO 创建幻灯片
    return emit createSuccessEvent();
}

void SlideManagementEditController::updateSlide(const QString& title, const QString& link,
                                                const QString& url) {
    // TODO 更改幻灯片
    return emit updateSuccessEvent();
}

void SlideManagementEditController::onClickSubmit(const QString& title, const QString& link,
                                                  const QString& url, const bool& isEdit) {
    if (isEdit)
...
SlideManagementEditController* SlideManagementEditController::create(QQmlEngine* qmlEngine,
                                                                     QJSEngine* jsEngine) {
