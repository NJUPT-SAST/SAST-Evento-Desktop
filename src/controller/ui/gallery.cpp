...
void GalleryController::loadGalleryDirJson() {
    ...
    QString galleryUrlList = "[{\"id\":1,\"name\":\"default\"},{\"id\":2,\"name\":\"1st "
                             "dir\"},{\"id\":3,\"name\":\"2nd dir\"}]";
...
void GalleryController::loadGalleryDirImgInfo(const QString& dirName, const int pageNumber) {
    ...
    QString imgJson =
        "[\"qrc:/res/image/ic_home_github.png\",\"qrc:/res/image/banner_3.png\",\"qrc:/res/image/"
        "banner_2.png\",\"qrc:/res/image/banner_1.png\"]";
    QString galleryDirImgInfo =
        "{\"count\":\"" + QString::number(pageItemCount) + "\",\"url\":" + imgJson + "}";
